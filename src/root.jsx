...
class Root extends React.Component {
  constructor(props) {
    ...
    this.setProfDescripClassandContent = this.setProfDescripClassandContent.bind(
      this
    );
    ...
    return (
      <div id="root">
        <div className={`${this.state.opacityLayerClass} opacity-layer box`}>
          <div className="dataDescrip">
            {" "}
            traffic clustering in NYC <br /> <span> source: NYC DOT </span>{" "}
          </div>
          <div className={`${this.state.columnLayerClass} mainColumn`}>
            <div className="top series header">
              ...
              <AboutModal
                ...
                setProfDescripClassandContent={
                  this.setProfDescripClassandContent
                }
              />
            </div>
          ...
          <div className={`${this.state.profileDescripClass}`}>
            {" "}
