        ...
        <ShiftOutHOC startingSlide={s._6_strt + 2} endingSlide={s._6_strt + 14}>
          <StyledSVG>
            <image
              ...
              width="100%"
              href={
               require("./supply_demand_progression_01.svg")
              }
            />
          </StyledSVG>
        </ShiftOutHOC>
        <ShiftOutHOC startingSlide={s._6_strt + 3} endingSlide={s._6_strt + 14}>
          <StyledSVG>
            <image
              ...
              href={
               require("./supply_demand_progression_02.svg")
              }
            />
            <text
        ...
        <ShiftOutHOC startingSlide={s._6_strt + 5} endingSlide={s._6_strt + 14}>
          <StyledSVG>
            <image
              ...
              href={
               require("./supply_demand_progression_03.svg")
              }
            />
            <text
        ...
        <ShiftOutHOC startingSlide={s._6_strt + 6} endingSlide={s._6_strt + 10}>
          <StyledSVG>
            <image
              ...
              width="100%"
              href={
               require("./supply_demand_progression_04.svg")
              }
            />
            <text
        ...
        <ShiftOutHOC startingSlide={s._6_strt + 8} endingSlide={s._6_strt + 10}>
          <StyledSVG>
            <image
              ...
              width="100%"
              href={
               require("./supply_demand_progression_05.svg")
              }
            />
        ...
        >
          <StyledSVG>
            <image
              ...
              width="100%"
              href={
               require("./supply_demand_progression_06.svg")
              }
            />
            <text
        ...
        <ShiftOutHOC startingSlide={s._6_strt+12} endingSlide={s._6_strt + 14}>
          <StyledSVG>
            <image
              ...
              width="100%"
              href={
               require("./supply_demand_progression_07.svg")
              }
            />
            <text fill="white" x="320" y="120">
              PRICE SHIFTS UP
